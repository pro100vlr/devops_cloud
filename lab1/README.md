...
2.Создаю папки для сайтов, где в файлы записываю содержимое сайтов. Создаю SSL сертификатов и делаю настройку nginx
...
3.Настройка hosts и проверка работы(редиректа и работы HTTPS)
...
<img width="716" height="392" alt="Снимок экрана 2025-09-28 в 15 26 08" src="https://github.com/user-attachments/assets/88ae5472-6199-4da7-8797-f20f7661290a" />
